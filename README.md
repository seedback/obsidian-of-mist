...
2. Run `npm install` to install all the stuff you need, Including: 
   + vue3 (with tsx support)
   + typescript 5.9
   + vite 8.0 (with rolldown)
   + oxlint
...
If above steps work, you can turn on 'Vue Template' plugin in Obsidian. Click the *dice* like button on the left ribbon, a new tab will open on the right.
